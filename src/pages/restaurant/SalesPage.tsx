        ...
        <div className="flex items-center justify-between border-b border-border bg-card px-4 py-2">
          ...
          <div className="flex items-center gap-6">
            {[
              ...
              { label: "Promedio por venta", value: `$${Math.round(kpis.avgSale).toLocaleString()}` },
              { label: "Personas", value: String(kpis.people) },
              { label: "Promedio por persona", value: `$${Math.round(kpis.avgPerson).toLocaleString()}` },
            ...
            <Table>
              <TableHeader>
                <TableRow className="text-[11px]">
                  <TableHead className="w-20 pl-4">ID / Etiqueta</TableHead>
                  <TableHead className="w-36">Hora Inicio</TableHead>
                  ...
                  <TableRow
                    ...
                    className={cn(
                      ...
                      o.id === selectedOrderId
                        ? "bg-amber-100/80 hover:bg-amber-100/80"
                        : "hover:bg-muted/40"
                    )}
                  >
                    ...
                    <TableCell>
                      {o.status === "cerrado"
                        ? format(new Date(o.created_at), "dd/MM/yy HH:mm:ss")
                        : ""}
                    </TableCell>
      ...
      <div className="w-72 border-l border-border flex flex-col shrink-0 bg-card">
        ...
        <div className="flex items-center justify-between px-4 py-2 bg-amber-500">
          ...
          <div className="flex items-center gap-0.5">
            <Button variant="ghost" size="icon" className="h-7 w-7 text-white hover:bg-amber-600">
